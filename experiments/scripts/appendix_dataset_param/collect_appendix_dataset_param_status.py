...
LOCAL_OUTPUT_ROOT = LOCAL_REPO / "analysis" / "pipeline_20260519_appendix_dataset_param_compare"
...
REMOTE_EXP_ROOT = "/root/geoexplorer/ab_experiments/appendix_compare_20260519/anchor0624_dataset_param_appendix_seed321_480k"
REMOTE_OUTPUT_ROOT = "/root/geoexplorer/analysis/pipeline_20260519_appendix_dataset_param_compare"
STATUS_PATH = REMOTE_EXP_ROOT + "/monitoring/appendix_dataset_param_status_latest.json"
...
def main() -> int:
    parser = argparse.ArgumentParser(description="Collect appendix dataset/parameter comparison status.")
    ...
    with RemoteGeoClient(spec) as client:
        ...
        proc = client.run(
            ...
            "grep -E 'appendix_dataset_param_orchestrator.py|train.py|paper_geo_evaluator.py' | grep -v grep || true"
        )
        downloaded = []
